...
import {
  ...
  Plus, SlidersHorizontal, LogOut, FolderOpen,
} from 'lucide-react';
...
const ICON_MAP: Record<string, LucideIcon> = {
  dashboard: LayoutDashboard, stagegates: GitBranch, lims: FlaskConical,
  blockmodel: Boxes, analytics: BarChart3, granulometry: LineChart,
